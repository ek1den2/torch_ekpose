...
def main():
    ...
    parser.add_argument('-l', '--lr', type=float, default=0.001, help='学習率')
    ...
    parser.add_argument('--weight_decay', type=float, default=0.0001, help='重み減衰')
    ...
    if args.pretrained:
        ...
        # 特徴マップのレイヤーを凍結
        print(model.module) # モデルの構造を確認し凍結する層を決定　eg. OpenPose -> feature -> model -> (各層)
        for i in range(20):
